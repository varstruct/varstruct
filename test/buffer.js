...
test('encode', function (t) {
  ...
  t.test('destination buffer is too small', function (t) {
    t.throws(function () {
      buffer42.encode(Buffer.allocUnsafe(42), Buffer.allocUnsafe(42), 1)
  ...
  t.test('write value to buffer', function (t) {
    var buf1 = Buffer.allocUnsafe(42)
    var buf2 = Buffer.allocUnsafe(42)
...
test('decode', function (t) {
  t.test('not enough data for decode', function (t) {
    t.throws(function () {
      buffer42.decode(Buffer.allocUnsafe(42), 1)
